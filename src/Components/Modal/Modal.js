...
class Modal extends React.Component {
  ...
  render() {
    return (
      <>
        <Opener onClick={() => this.handleOpenModal("#modal1")}>
          Open Modal One
        </Opener>
        <Opener onClick={() => this.handleOpenModal("#modal2")}>
          Open Modal Two
        </Opener>
        <Outer className="modal-outer">
          <Popup id="modal1">
            <Header>Modal One</Header>
            <Body>
            ...
            <Closer onClick={this.handleCloseModal}>Close</Closer>
          </Popup>
        </Outer>
        <Outer className="modal-outer">
          <Popup id="modal2">
            <Header>Modal Two</Header>
            <Body>
